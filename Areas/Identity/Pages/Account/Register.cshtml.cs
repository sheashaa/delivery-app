    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null, string role = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var userName = Input.FirstName + Input.LastName + DateTime.Now.Millisecond.ToString();
                var normalizedUserName = userName.ToUpper();
                var newUser = new ApplicationUser { UserName = userName, NormalizedUserName = normalizedUserName, FirstName = Input.FirstName, LastName = Input.LastName, Email = Input.Email, NormalizedEmail = Input.Email.ToUpper(), EmailConfirmed = true };
